...
void processInput(GLFWwindow* window) {
    ...
    const float cameraSpeed = 2.5f * deltaTime; // 2.5 units per second
...
int notmain() {
    ...
    // Create textures and bind them to texture units
    ...
    trans = glm::translate(trans, glm::vec3(1.0f, 1.0f, 0.0f)); // Multiplied with translation matrix
    vec = trans * vec;
    ...
    while (!glfwWindowShouldClose(window)) {
       ...
       /* glm::mat4 trans = glm::mat4(1.0f);
        ...
        // Transforms model to world
        glm::mat4 model = glm::mat4(1.0f);
        //model = glm::rotate(model, glm::radians(-55.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        model = glm::rotate(model, (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
        // Transforms world to "camera" (inverse operations on world)
        glm::mat4 view = glm::mat4(1.0f);
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
        // Transforms camera to clip
